...
void main() 
{
	...
	float theta = acos(direction.y); // 0elevation --> y-axis, [-pi/2, pi/2]
...
for mat in mesh.materials:
	...
	if shader != None:
		...
		shader.setUniform1f('luminance',0.89)
		shader.setUniform1f('turbidity',1.0)
		shader.setUniform1f('reileigh',2.0)
		shader.setUniform1f('bias',1.0)
		shader.setUniform1f('contrast',6.0)
		shader.setUniform1f('lumamount',0.5)